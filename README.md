...
<p align="center">
  ...
  <br />
  基于 riba2534 原作整理的三个可玩的 3D 网页游戏。
</p>
...
原作者用 [Claude Opus 5.5](https://www.anthropic.com/claude/opus)（Claude Code CLI，1M 上下文，xhigh 推理强度）做的一次代码生成能力实测：**每个游戏只给一句话提示词，单会话 one-shot 生成，原版生成后直接部署上线可玩。**
